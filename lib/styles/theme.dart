...
ThemeData kCustomTheme = ThemeData.dark().copyWith(
  ...
  textTheme: const TextTheme(
    ...
    titleSmall: TextStyle(color: CustomColor.whitePrimary, fontWeight: FontWeight.w500, fontSize: 15),
    ...
    bodySmall: TextStyle(color: CustomColor.whiteSecondary, fontSize: 11),
